...
public class DetallePagoStoredProcedure extends StoredProcedure{
	
private static final String SPROC_NAME = "trxconc.sir_get_detalle_pago";
	
	private static final String ID_RENDICION_IN	= "IN_ID_PAGO";
	...
	public DetallePagoStoredProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter(cur_usuario_out, Types.OTHER, new DetallePagoMapper()));
