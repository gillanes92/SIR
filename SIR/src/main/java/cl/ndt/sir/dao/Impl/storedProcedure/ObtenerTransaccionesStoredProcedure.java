...
import cl.ndt.sir.dao.Impl.storedProcedure.mapper.TransaccionesMapper;

public class ObtenerTransaccionesStoredProcedure extends StoredProcedure{
	
private static final String SPROC_NAME = "oneclick.select_transacciones_empresa";
	...
	public ObtenerTransaccionesStoredProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter(cur_usuario_out, Types.OTHER, new TransaccionesMapper()));
