...
import cl.ndt.sir.dao.Impl.storedProcedure.mapper.RendicionMapper;

public class RendicionListarStoredProcedure extends StoredProcedure{
	
	private static final String SPROC_NAME = "repconc.sir_rep_listado_rendiciones";
	...
	public RendicionListarStoredProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter(cur_usuario_out, Types.OTHER, new RendicionMapper() ));
